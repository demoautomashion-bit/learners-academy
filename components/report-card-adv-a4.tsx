...
export function ReportCardAdvA4({
  ...
  return (
    ...
    >
      ...
      {/* Transcript No: Static TLA-ADV- prefix + editable tail sequence */}
      <div
      ...
      >
        ...
        <input
          type="text"
          value={(values.transcriptNo || defaultTranscriptNo).replace(/^TLA-ADV-/i, '')}
          onChange={e => {
            const raw = e.target.value
            handleValueChange('transcriptNo', raw.toUpperCase().startsWith('TLA-ADV-') ? raw : `TLA-ADV-${raw}`)
          }}
          disabled={readOnly}
          className="adv-overlay-input font-medium flex-1 h-full"
      ...
      <input
        ...
        style={{ top: '36.8%', left: '75.0%', width: '19.0%', height: '3.1%', fontSize: '15px' }}
      />
      ...
      <input
        ...
        disabled={readOnly}
        className="adv-overlay-input text-center font-bold"
        style={{ top: '40.6%', left: '75.0%', width: '19.0%', height: '3.1%', fontSize: '15px' }}
      />
      ...
      <input
        ...
        disabled={readOnly}
        className="adv-overlay-input text-center font-bold"
        style={{ top: '44.4%', left: '75.0%', width: '19.0%', height: '3.1%', fontSize: '15px' }}
      />
      ...
      <input
        ...
        disabled={readOnly}
        className="adv-overlay-input text-center font-bold"
        style={{ top: '48.2%', left: '75.0%', width: '19.0%', height: '3.1%', fontSize: '15px' }}
      />
      ...
      <input
        ...
        disabled={readOnly}
        className="adv-overlay-input text-center font-bold"
        style={{ top: '52.0%', left: '75.0%', width: '19.0%', height: '3.1%', fontSize: '15px' }}
      />
      ...
      <input
        ...
        disabled={readOnly}
        className="adv-overlay-input text-center font-bold"
        style={{ top: '55.8%', left: '75.0%', width: '19.0%', height: '3.1%', fontSize: '15px' }}
      />
      ...
      <input
        ...
        disabled={readOnly}
        className="adv-overlay-input text-center font-bold"
        style={{ top: '59.6%', left: '75.0%', width: '19.0%', height: '3.1%', fontSize: '15px' }}
      />
      ...
      <input
        ...
        disabled={readOnly}
        className="adv-overlay-input text-center font-bold"
        style={{ top: '63.4%', left: '75.0%', width: '19.0%', height: '3.1%', fontSize: '15px' }}
      />
      ...
      <input
        ...
        style={{ top: '67.2%', left: '75.0%', width: '19.0%', height: '3.2%', fontSize: '16px' }}
      />
