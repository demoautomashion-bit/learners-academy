  ...
  return (
    ...
    >
      ...
      <input
        ...
        style={{ top: '67.5%', left: '75.5%', width: '18.5%', height: '3.3%', fontSize: '16px' }}
      />
      ...
      <input
        ...
        style={{ top: '73.7%', left: '41.0%', width: '12%', height: '1.9%', fontSize: '14px' }}
      />
      ...
      <input
        ...
        disabled={readOnly}
        className="adv-overlay-input font-bold"
        style={{ top: '73.7%', left: '64.5%', width: '28%', height: '1.9%', fontSize: '14px' }}
      />
      ...
      <input
        ...
        disabled={readOnly}
        className="adv-overlay-input font-bold"
        style={{ top: '76.6%', left: '41.0%', width: '12%', height: '1.9%', fontSize: '14px' }}
      />
      ...
      <input
        ...
        disabled={readOnly}
        className="adv-overlay-input font-bold"
        style={{ top: '76.6%', left: '62.5%', width: '31%', height: '1.9%', fontSize: '13px' }}
      />
    </div>
  )
}
